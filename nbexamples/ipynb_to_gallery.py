...
def convert_all_in_folder_to_gallery(
    folder: str, out_folder: Optional[str] = None, replace: bool = False
):
...
if __name__ == "__main__":
    ...
    parser.add_argument("folder", help="Folder to convert ipynb to Sphinx Gallery py")
    parser.add_argument(
        "-o",
        "--out-folder",
        default=None,
